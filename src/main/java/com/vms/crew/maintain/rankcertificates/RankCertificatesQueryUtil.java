...
public class RankCertificatesQueryUtil {
	...
	public static final String getList = "select certificate_code as certificatecode,certificate_name as categories from certificate_master order by created_dt desc";
