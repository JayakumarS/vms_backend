...
public class RankTrainingsQueryUtil {
	...
	public static final String SAVE_trainings= "Insert into training(training_code,rank_code,created_by,created_dt)"
	...
	public static final String checkDelete = "select count(*) from training where training_code = ? and rank_code = ?";


	public static final String getListALL = "SELECT training_code AS trainingcode,rank_code AS rankcode FROM training  ORDER BY created_dt DESC";

	public static final String DELETE_trainings = "DELETE FROM training WHERE rank_code = ?";
