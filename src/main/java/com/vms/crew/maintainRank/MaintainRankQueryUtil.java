...
public class MaintainRankQueryUtil {
	...
	public static final String SAVE_VESSEL_TYPE = "Insert into rank_master (rank_id,rank_code,rank_name,dept_code,rank_group_code,ot_flag,rank_remarks,created_by,created_dt)\r\n"
			+ "values (:sno,:code,:description,:department,:groupage,:oAndt,:remarks,:userName,now())";

public static final String getList = "select rank_id as sno,rank_code as code,rank_name as description,dept_code as department,rank_group_code as groupage,ot_flag as oAndt,rank_remarks as remarks from rank_master order by created_dt desc";

public static final String getEdit = "select rank_id as sno,rank_code as code,rank_name as description,dept_code as department,rank_group_code as groupage,ot_flag as oAndt,rank_remarks as remarks from rank_master where rank_code = ?";
