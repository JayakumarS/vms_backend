...
public class PersonMaintenanceQueryUtil {
	...
	public static final String SAVE_CREW_MASTER = "Insert into crew_master "
			...
			+ "remarks_two, recom_by, status,created_by, created_dt) "
	...
	public static final String SAVE_CREW_MASTER_DOCUMENT = "Insert into crew_master_document "
			...
			+ "sid_file_path, sid_file_name, cv_file_path, cv_file_name, created_by, created_dt) "
			...
			+ ":sidFileName,:cvFilePath,:cvFileName,:userName,now()) ";
//	
...
//			+ "order by person_maintenance_code desc ";
	...
	public static final String GET_LIST = "select crew_master_code as code,crew_master_surname as surname,crew_master_name as name,status as active,cm.country_name as nationality, "
			...
			+ "from crew_master pm "
			+ "left join rank_master rm on rm.rank_code = pm.crew_master_rank "
			+ "left join agent_master am on am.agent_code = pm.crew_master_agent "
			+ "left join work_status w on w.work_status_code  = pm.crew_master_work_status "
			+ "left join country_master cm on cm.country_code = pm.crew_master_nationality "
	...
	public static final String GET_CREW_MASTER_DOCUMENT_DTLS = "select crew_master_passport as passPort,to_char(passport_issue,'dd/mm/yyyy') as pIssue,to_char(passport_expiry,'dd/mm/yyyy') as pExpiry,passport_issue_place as pIssuePlace, "
			...
			+ "pan_no as pan,aadhar_no as adhar from crew_master_document cmd where crew_master_code = ? ";
	...
	public static final String UPDATE_CREW_MASTER = "update crew_master "
			...
			+ "remarks_one=:remarksOne, remarks_two=:remarksTwo, recom_by=:reCom, status=:active,modified_by=:userName, modified_dt=now() "
	...
	public static final String UPDATE_CREW_MASTER_DOCUMENT = "update crew_master_document "
			...
			+ "cv_file_name=:cvFileName,modified_by=:userName, modified_dt=now() "
			+ "where crew_master_code=:code ";
	
	public static final String GET_APPLICANT_LIST = "select appl_sur_name as surname, appl_name as name, appl_middle_name as middle, appl_nationality as nationality, "
			...
			+ "cv_operations_file_path,rm.rank_name as rankName from crew_applicant ca "
			+ "left join rank_master rm on rm.rank_code = ca.appl_rank ";
}
