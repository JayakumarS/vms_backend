...
//			+ "order by person_maintenance_code desc ";
	...
	public static final String GET_DETAILS="SELECT crew_master_id as id, crew_master_code as code, crew_master_surname as surname, crew_master_name as name,"
			...
			+"to_char(crew_master_last_sign_off,'dd/mm/yyyy') as signedOff, to_char(crew_master_available_from,'dd/mm/yyyy') as availableFrom, remarks_one as remarksOne, status as active,"
			+ "crew_master_age as age , crew_master_comp_service as compService ,crew_master_sea_service as seaService ,crew_master_years_rank as yearsInRank  FROM crew_master"
