...
public class EmployeeMasterDaoImpl implements EmployeeMasterDao{
	...
	public EmployeeMasterBean getCompanyLogo() {
		// TODO Auto-generated method stub
		EmployeeMasterBean logo = new EmployeeMasterBean();
		try {
			logo = jdbcTemplate.queryForObject(EmployeeMasterQueryUtil.GET_COMPANY_LOGO, new Object[] {}, new BeanPropertyRowMapper<EmployeeMasterBean>(EmployeeMasterBean.class));
		}catch (Exception e) {
