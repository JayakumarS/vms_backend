...
public class SupplieDepartmentQueryUtil {
	...
	public static final String SAVE_SUPPLIE_DEPARTMENT = "Insert into supplie_department "
			+ "(supplie_department_code,supplie_dep_code,supplie_department_name, form_type, item_order_comment, item_not_order_comment, tolerance, "
			...
			+ "values(:code,:depCode,:depName,:formType,:itemOrder,:itemNotOrder,:tol,:minItem,to_date(:lscInv,'dd/mm/yyyy'),:availOff,:availVsl,:offUndefine,:vslUndefine,:pItems,now(),:userName) ";
	
	public static final String UPDATE_SUPPLIE_DEPARTMENT = "update supplie_department "
			+ "set supplie_department_name=:depName,supplie_dep_code=:depCode form_type=:formType, item_order_comment=:itemOrder, "
